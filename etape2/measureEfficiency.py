import heatDiffusion_refactored
import time
...
def testMultipleTimes():
    ...
    for i in range(10, 110, 10):    #de 10 à 100 inclu
        startTime = time.time()
        heatDiffusion_refactored.HDPlot(i, i, nbIterations, False)
        endTime = time.time()
